...
A lo largo de este documento de desarrolla la explicacion y la configuracion del bot utilizando la red de poligon en OpenSea y la wallet de Metamask, pero se petende que al final del documento tu puedas configurarlo para cualquier Mercado, Red y Wallet.
...
Para descargar el Bot debemos hacer clic en el boton "Code" y despues haremos clic en "Download ZIP".

![image](https://user-images.githubusercontent.com/91817247/136246546-e96c1776-82be-47b0-9071-729323c71d76.png)

Se decargara una archivo ZIP llamado **SimpleOpenSeaBot-main** el cual debemos descomprimir, dentro hay una carpeta que contiene el archivo **SimpleOpenSeaBot.au3** el cual es el script del bot.
